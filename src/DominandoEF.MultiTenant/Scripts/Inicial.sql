...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20210527201730_Tenant01')
BEGIN
    CREATE TABLE [People] (
...
BEGIN
    ...
    EXEC(N'INSERT INTO [People] ([Id], [Name], [TenantId])
...
BEGIN
    ...
    EXEC(N'INSERT INTO [Products] ([Id], [Description], [TenantId])
...
BEGIN
    ...
    VALUES (N'20210527201730_Tenant01', N'5.0.6');
END;
GO
